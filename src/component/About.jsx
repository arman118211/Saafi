    ...
    <section className="relative h-[80vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="container mx-auto px-4 z-10 text-center">
        ...
        >
          ...
          >
            Pioneering innovation and excellence since 2018
          </motion.p>
        ...
        >
          <motion.div variants={itemVariants} className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-5xl font-bold mb-4 text-gray-800">
              Pioneering <span className="text-[#5851DB]">Excellence</span> Since 2018
            </h2>
            <div className="w-24 h-1 bg-red-600 mx-auto"></div>
          </motion.div>

          <motion.p variants={itemVariants} className="text-lg text-gray-700 mb-6">
            Saafi Ariel Industries was founded with a vision to revolutionize the industry through innovative solutions
            and cutting-edge technology. What began as a small startup has now grown into a global leader in our field.
          </motion.p>

          <motion.p variants={itemVariants} className="text-lg text-gray-700 mb-10">
            Our journey has been defined by a relentless pursuit of excellence, a commitment to sustainability, and a
            passion for creating products that make a difference in people's lives.
          </motion.p>
          ...
          <motion.div variants={itemVariants} className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
            <div className="bg-white p-8 rounded-xl shadow-lg text-center transform transition-all duration-300 hover:-translate-y-2 hover:shadow-xl">
              ...
              <p className="text-gray-600">Proudly operating exclusively in Nepal, serving clients across the nation with a deep understanding of local needs and values.</p>
            </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg text-center transform transition-all duration-300 hover:-translate-y-2 hover:shadow-xl">
              ...
              <p className="text-gray-600">Over 500 dedicated professionals working to deliver excellence</p>
            </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg text-center transform transition-all duration-300 hover:-translate-y-2 hover:shadow-xl">
              ...
              <p className="text-gray-600">Delivering excellence through innovation and sustainable practices</p>
            </div>
          </motion.div>
        </motion.div>
      </div>
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <h2 className="text-3xl md:text-5xl font-bold mb-4 text-gray-800">
              Leadership <span className="text-red-600">That Inspires</span>
            </h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <h3 className="text-2xl md:text-3xl font-bold mb-6 text-gray-800">
                Meet Our <span className="text-[#5851DB]">Visionary Leader</span>
              </h3>
              <p className="text-lg text-gray-700 mb-6">
                Mr. Kalamuddeen, the visionary founder and CEO of Saafi Ariel Industries, has been at the forefront of
                innovation for over 15 years. With a background in engineering and business management, Kalamuddeen has led
                the company through remarkable growth and transformation.
              </p>
              <p className="text-lg text-gray-700 mb-8">
                Under Kalamuddeen's leadership, our company has expanded globally, pioneered groundbreaking technologies, and
                maintained an unwavering commitment to quality and customer satisfaction.
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-white p-4 rounded-xl shadow-md border border-gray-100">
                  <div className="flex items-center">
                    ...
                    <div>
                      <h4 className="font-semibold text-lg">15+ Years Experience</h4>
                ...
                <div className="bg-white p-4 rounded-xl shadow-md border border-gray-100">
                  <div className="flex items-center">
                    ...
                    <div>
                      <h4 className="font-semibold text-lg">Multiple Awards</h4>
                      <p className="text-gray-600">Recognition for excellence</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white p-4 rounded-xl shadow-md border border-gray-100">
                  <div className="flex items-center">
                    ...
                    <div>
                      <h4 className="font-semibold text-lg">Global Leader</h4>
                      <p className="text-gray-600">Transforming the industry</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white p-4 rounded-xl shadow-md border border-gray-100">
                  <div className="flex items-center">
                    ...
                    <div>
                      <h4 className="font-semibold text-lg">Visionary</h4>
                      <p className="text-gray-600">Innovative thinking</p>
                    </div>
                  </div>
                </div>
              </div>
  ...
  const timelineEvents = [
    {
      ...
      description: "Saafi Ariel Industries was established with a vision to transform the industry.",
    },
    {
      year: "2020",
      title: "First Major Product Launch",
      description: "Released our flagship product that revolutionized the market.",
    },
    {
      year: "2022",
      title: "Expanding Across Nepal",
      description: "Opened our first regional offices across key locations in Nepal.",
    },
    {
      year: "2023",
    ...
    },
    {
      ...
      description: "Launched our sustainability program with commitment to carbon neutrality.",
    },
    {
      year: "2025",
      title: "Global Leadership",
      description: "Became the industry leader with a strong and dedicated presence across Nepal.",
    },
  ]
    ...
    <section className="py-20 bg-gray-50 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <h2 className="text-3xl md:text-5xl font-bold mb-4 text-gray-800">
            The <span className="text-[#5851DB]">Saafi Ariel</span> Timeline
          </h2>
          <p className="text-lg text-gray-700 max-w-3xl mx-auto">
            A journey of innovation, growth, and excellence through the years
          </p>
        </motion.div>
...
const ValuesSection = () => {
  ...
  const values = [
    ...
    {
      title: "Integrity",
      description: "Honest and ethical conduct in all our business dealings",
      icon: <Shield className="w-8 h-8" />,
      color: "bg-red-600",
    },
    {
      title: "Sustainability",
      description: "Creating solutions that protect our planet for future generations",
    ...
    <section className="py-20 bg-white">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <h2 className="text-3xl md:text-5xl font-bold mb-4 text-gray-800">
            Our Core <span className="text-[#5851DB]">Values</span>
          </h2>
          <p className="text-lg text-gray-700 max-w-3xl mx-auto">
            These principles guide everything we do at Saafi Ariel Industries
          </p>
        </motion.div>
...
const TestimonialsSection = () => {
  ...
  const testimonials = [
    {
      quote:
        "Saafi Ariel Industries has been an incredible partner. Their innovative solutions have transformed our business operations completely.",
      author: "Customer",
      position: "Thankyou",
    ...
    {
      quote:
        "Working with Saafi Ariel has been a game-changer for our company. Their attention to detail and commitment to excellence is unmatched.",
      author: "Customer",
      position: "Thankyou",
    ...
    {
      quote:
        "The level of innovation and technical expertise at Saafi Ariel Industries is truly impressive. They've helped us stay ahead of the competition.",
      author: "Customer",
      position: "Thankyou",
...
const AchievementsSection = () => {
  ...
  const achievements = [
    { number: "200+", text: "Employees Worldwide" },
    { number: "1+", text: "Countries Served" },
    { number: "15+", text: "Years of Excellence" },
    { number: "20,000+", text: "Major Products Completed" },
  ]
    ...
    <section className="py-20 bg-white">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <h2 className="text-3xl md:text-5xl font-bold mb-4 text-gray-800">
            Life at <span className="text-red-600">Saafi Ariel</span>
          </h2>
          <p className="text-lg text-gray-700 max-w-3xl mx-auto">
            We believe in creating a workplace where innovation thrives and people love what they do
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="flex items-start">
              ...
              <div>
                <h3 className="text-xl font-bold mb-2 text-gray-800">Passionate Teams</h3>
                <p className="text-gray-600">
                  Our teams are made up of passionate individuals who are dedicated to making a difference through their
                  work. We foster a culture of collaboration and mutual respect.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div>
                <h3 className="text-xl font-bold mb-2 text-gray-800">Innovation Hub</h3>
                <p className="text-gray-600">
                  We've created an environment where creative thinking is encouraged and new ideas can flourish. Our
                  innovation labs are spaces where the future is shaped.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div>
                <h3 className="text-xl font-bold mb-2 text-gray-800">Inclusive Environment</h3>
                <p className="text-gray-600">
                  We celebrate diversity and believe that different perspectives lead to better solutions. Everyone's
                  voice is valued and heard at Saafi Ariel Industries.
                </p>
              </div>
            </div>
          </motion.div>
...
const AwardsSection = () => {
  ...
  const awards = [
    ...
    },
    {
      ...
      organization: "Environmental Business Council",
    },
    {
      year: "2021",
      title: "Best Workplace Culture",
      organization: "Industry HR Association",
    },
    {
      year: "2020",
    ...
    <section className="py-20 bg-gray-50">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <h2 className="text-3xl md:text-5xl font-bold mb-4 text-gray-800">
            Our <span className="text-[#5851DB]">Awards</span> & Recognition
          </h2>
          <p className="text-lg text-gray-700 max-w-3xl mx-auto">
