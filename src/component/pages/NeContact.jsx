  ...
  return (
    <section className="relative h-[80vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="container mx-auto px-4 z-10 text-center ">
        ...
        >
          संपर्क <span className="">गर्नुहोस्</span>
        </motion.h1>
        <motion.p
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          हामी तपाईंबाट सुनन चाहन्छौं। हाम्रो टोलीसँग सम्पर्क गर्नुहोस्।
        </motion.p>
      </div>
      ...
      <div className="container mx-auto px-4">
        ...
        >
          <motion.div variants={itemVariants} className="text-center mb-12">
            ...
            हामी तपाईंबाट <span className="text-[#5851DB]">सुनन चाहन्छौं</span>
            </h2>
        ...
        <div className="max-w-5xl mx-auto bg-gradient-to-br from-[#5851DB]/5 to-red-100/20 rounded-2xl shadow-2xl overflow-hidden">
          <div className="grid grid-cols-1 md:grid-cols-2">
            <div className="bg-gradient-to-br from-[#5851DB] to-red-600 p-12 text-white">
              <h3 className="text-2xl font-bold mb-6">संपर्क गर्नुहोस्</h3>
              <p className="mb-8">
              हामी तपाईंबाट सुनन चाहन्छौं। कुनै पनि जिज्ञासा वा साझेदारी अवसरहरूको लागि हामीलाई सम्पर्क गर्नुहोस्।.
              </p>
    ...
    <section className="py-20 bg-gray-50">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <h2 className="text-3xl md:text-5xl font-bold mb-4 text-gray-800">
          हामीलाई <span className="text-red-600">पत्ता लगाउनुहोस्</span>
          </h2>
          <p className="text-lg text-gray-700 max-w-3xl mx-auto">हाम्रो मुख्यालय वा हाम्रो विश्वव्यापी कार्यालयहरू मध्ये कुनै एकमा भ्रमण गर्नुहोस्</p>
        </motion.div>
...
const FAQSection = () => {
  ...
  const faqs = [
    {
        question: "मैले प्रतिक्रिया पाउने कति चाँडो अपेक्षा गर्न सक्छु?",
        answer: "हामी व्यापारिक दिनहरूमा सबै जिज्ञासाहरूलाई २४ घण्टाभित्र प्रतिक्रिया दिन प्रयास गर्छौं। तात्कालिक समस्याहरूको लागि, कृपया हाम्रो ग्राहक समर्थन लाइनमा सिधै फोन गर्नुहोस्।"
      },
      {
        question: "के तपाईं नयाँ ग्राहकहरूको लागि परामर्श प्रदान गर्नुहुन्छ?",
        answer: "हो, हामी सम्भावित ग्राहकहरूका लागि निःशुल्क प्रारम्भिक परामर्श प्रदान गर्छौं। यस सत्रमा, हामी तपाईंको आवश्यकताहरू र हाम्रो सेवाहरूले तपाईंलाई कसरी लक्ष्यहरू प्राप्त गर्न मद्दत गर्न सक्छ भनेर छलफल गर्नेछौं।"
      },
      {
        question: "तपाईं कुन उद्योगहरूको सेवा प्रदान गर्नुहुन्छ?",
        answer: "साफी एरियल इन्डस्ट्रीजले डिटर्जन्टसँग सम्बन्धित उत्पादन र सेवाहरूमा विशेषज्ञता प्राप्त गरेको छ। हामी घरमै डेलिभरी सेवा पनि प्रदान गर्दछौं, जसले विभिन्न ग्राहकहरूको आवश्यकता अनुसार धेरै क्षेत्रहरूमा सेवा पुर्याउँछ।"
      },
      {
        question: "के तपाईंको अन्तर्राष्ट्रिय समर्थन छ?",
        answer: "होइन, हामी नेपाल भित्र मात्र सेवाहरू प्रदान गर्दछौं। हाम्रो टोलीले देशभरिका ग्राहकहरूको जिज्ञासा र आवश्यकताहरूको समाधान गर्न समर्पित छ।"
      },
      {
        question: "म कसरी उत्पादन प्रदर्शनको अनुरोध गर्न सक्छु?",
        answer: "तपाईं यस पृष्ठमा रहेको सम्पर्क फारम भरी या saafi2074@gmail.com मा तपाईंको विशेष आवश्यकतासहित इमेल गरेर उत्पादन प्रदर्शनको अनुरोध गर्न सक्नुहुन्छ।"
      },
      {
        question: "तपाईंको सामान्य परियोजना समयरेखा के हो?",
        answer: "परियोजनाका समयरेखाहरू दायरा र जटिलतामा निर्भर गर्दै फरक पर्छ। हाम्रो प्रारम्भिक परामर्शमा, हामी तपाईंको विशेष परियोजना आवश्यकताहरूको आधारमा एक विस्तृत समयरेखा प्रदान गर्नेछौं।"
      },
  ]
    ...
    <section className="py-20 bg-white">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <h2 className="text-3xl md:text-5xl font-bold mb-4 text-gray-800">
          प्रायः <span className="text-[#5851DB]">सोधिने प्रश्नहरू (FAQ)</span>
          </h2>
          ...
          >
            <p className="text-lg text-gray-700">
              ...
              <a href="#" className="text-[#5851DB] font-semibold hover:underline">
                हाम्रो समर्थन टोलीसँग सम्पर्क गर्नुहोस्
              </a>
            </p>
          </motion.div>
        </div>
...
const OfficeHoursSection = () => {
  ...
  const officeHours = [
    { "day": "सोमबार", "hours": "९:०० बिहान - ६:०० साँझ" },
    { "day": "मंगलबार", "hours": "९:०० बिहान - ६:०० साँझ" },
    { "day": "बुधबार", "hours": "९:०० बिहान - ६:०० साँझ" },
    { "day": "बिहीबार", "hours": "९:०० बिहान - ६:०० साँझ" },
    { "day": "शुक्रबार", "hours": "९:०० बिहान - ६:०० साँझ" },
    { "day": "शनिबार", "hours": "९:०० बिहान - ६:०० साँझ" },
    { "day": "आईतवार", "hours": "९:०० बिहान - ६:०० साँझ" },
  ]
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <h2 className="text-3xl md:text-4xl font-bold mb-6 text-gray-800">
               हाम्रो <span className="text-red-600">कार्यालय घण्टाहरू</span>
              </h2>
              <p className="text-lg text-gray-700 mb-8">
                हाम्रो टोली तपाईलाई तलका घण्टामा सहयोग गर्न उपलब्ध छ। यी घण्टाबाहेक तात्कालिक समस्याहरूको लागि, कृपया हाम्रो आपतकालीन सम्पर्क लाइन प्रयोग गर्नुहोस्।
              </p>
              ...
              <div className="mt-8 p-4 bg-[#5851DB]/10 rounded-lg">
                <p className="text-[#5851DB] font-medium">
                  <span className="font-bold">नोट: </span> चाडपर्वका समयमा घण्टाहरू फरक हुन सक्छन्। कृपया हाम्रा सामाजिक मिडिया च्यानलहरूमा चाडपर्वको तालिका हेर्नुहोस्।
                </p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="absolute bottom-8 left-0 right-0 bg-white/90 backdrop-blur-4xs p-6 mx-8 rounded-xl shadow-lg">
                <h3 className="text-xl font-bold mb-2 text-gray-800">तत्काल सहयोग चाहिन्छ?</h3>
                <p className="text-gray-600 mb-4">हाम्रो समर्थन टोली तपाईंका कुनै पनि प्रश्नहरूको उत्तर दिन मद्दत गर्न तयार छ।</p>
                <div className="flex items-center">
                  <Phone className="w-5 h-5 text-red-600 mr-2" />
                  <span className="font-semibold">आपतकालिन समर्थन: +977-982-6448200-HELP</span>
                </div>
              </div>
            </motion.div>
          </div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
            <h2 className="text-3xl md:text-5xl font-bold mb-6">तपाईंको व्यवसाय रूपान्तरण गर्न तयार हुनुहुन्छ?</h2>
            <p className="text-xl mb-8 opacity-90">
            साफी एरियल इन्डस्ट्रीजसँग साझेदारी गरी नवीनता ल्याउन र बढ्न सफल भएका सैकड़ों व्यवसायहरूको समूहमा सामेल हुनुहोस्।
            </p>
