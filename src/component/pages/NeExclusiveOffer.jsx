      ...
      <div className="container mx-auto">
        ...
        >
          <h2 className="text-3xl md:text-5xl font-bold mb-4 text-gray-800">
            विशेष <span className="text-[#5851DB]">प्रस्ताव</span>
          </h2>
          <motion.div
        ...
        >
          हाम्रो विशेष प्रस्तावहरू र प्रचारहरू अन्वेषण गर्नुहोस् जुन तपाईंलाई सबैभन्दा उत्तम मूल्य दिनको लागि डिजाइन गरिएको हो। यी विशेष डिलहरूको लाभ कसरी लिन सकिन्छ भनेर जान्नको लागि तलको ब्यानरमा क्लिक गर्नुहोस्।
        </motion.p>
        ...
        >
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-[#ff0000]/30 to-[#5851DB]/30 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
            <div className="bg-white/80 backdrop-blur-sm px-6 py-3 rounded-full flex items-center">
              ...
              <span className="font-bold text-[#5851DB]">प्रस्ताव हेर्नको लागि यहाँ क्लिक गर्नुहोस्</span>
            </div>
          </div>
        </motion.div>
            ...
            >
              ...
              >
                ...
                <div className="space-y-4 sm:space-y-5">
                  <h4 className="text-lg sm:text-xl font-semibold text-[#5851DB]">कसरी प्रयोग गर्ने:</h4>
                  <ol className="list-decimal pl-5 space-y-2 sm:space-y-3 text-gray-700 text-sm sm:text-base">
                    <li>कुनै पनि उच्च गुणस्तरको डिटर्जेन्ट उत्पादन किनमेल गर्नुहोस्।</li>
                    <li>प्याकेजिङ भित्र प्रोमोशनल कुपन खोज्नुहोस्।</li> 
                    <li>पुरस्कारको लागि योग्य बन्नको लागि ४ कुपन संकलन गर्नुहोस्।</li> 
                    <li>कुपनहरू रिडेम्प्शन केन्द्र वा वेबसाइटमा प्रस्तुत गर्नुहोस् र १० ग्राम चाँदीको सिक्का जित्नको लागि लक्की ड्र मा भाग लिनुहोस्।</li>
                  </ol>

                  <div className="bg-gray-50 p-3 sm:p-4 rounded-lg mt-4 sm:mt-6 border-l-4 border-[#5851DB]">
                    <p className="text-xs sm:text-sm text-gray-500">
                      *प्रस्ताव आपूर्ति समाप्त नभएसम्म मान्य छ। शर्त र अवस्था लागू हुन्छ।
                    </p>
                  </div>
                </div>
              </motion.div>
...
export default NeExclusiveOffer