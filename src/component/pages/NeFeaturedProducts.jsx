    ...
    <section className="py-20 px-4 bg-gradient-to-b from-gray-50 to-white">
      <div className="container mx-auto">
        <div className="text-center relative mb-16">
          ...
          >
            <h2 className="text-3xl md:text-5xl font-bold mb-4 text-gray-800">
              विशेष <span className="text-[#5851DB]">उत्पादनहरू</span>
            </h2>
          </motion.h2>
          ...
          >
            हाम्रो सबैभन्दा लोकप्रिय सफा गर्ने समाधानहरूको खोजी गर्नुहोस्, उत्कृष्ट परिणामका लागि प्रिमियम सामग्रीहरूको साथ बनाइएको।
          </motion.p>
        </div>
              ...
              <div className="p-6 relative bg-gradient-to-br from-white to-gray-50">
                ...
                >
                  ...
                  >
                    ...
                    <span className="font-bold">अहिले किनमेल गर्नुहोस्</span>
                  </motion.div>
                </Link>
              </div>
            </motion.div>
        ...
        <div className="text-center mt-20">
          <Link to="/Ne-shop" className="inline-block">
            <motion.div
...
export default NeFeaturedProducts