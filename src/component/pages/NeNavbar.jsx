...
export default function NeNavbar() {
        ...
        <div className="max-w-7xl mx-auto flex justify-between items-center p-2  mr-4">
          ...
          <div className="flex-1 flex justify-center md:justify-end items-center gap-4">
            ...
            <div className="hidden md:flex items-center space-x-4">
              <Link to="/Ne-why-choose-us" className="text-blue-700 hover:text-blue-900 font-bold transition-colors text-sm">
                हामीलाई किन छान्ने
              </Link>
              <Link to="/Ne-contact" className="text-blue-700 hover:text-blue-900 font-bold transition-colors text-sm">
          ...
          <div className="hidden absolute top-16 left-100 md:flex justify-center ">
            <nav className="flex gap-12 py-1">
              <motion.div 
                ...
                whileHover="hover"
              >
                <Link to="/Ne-shop">उत्पादनहरू किनमेल गर्नुहोस्</Link>
                <motion.span 
              ...
              <motion.div 
                ...
                whileHover="hover"
              >
                <Link to="/Ne-how-to-wash">कसरी कपडा धुनुहोस्</Link>
                <motion.span 
                  className="absolute -bottom-1 left-0 h-0.5 bg-blue-700 w-0"
                  variants={{
                    hover: { width: "100%" }
              ...
              <motion.div 
                ...
                whileHover="hover"
              >
                <Link to="/Ne-about">साफी एरियलको बारेमा</Link>
                <motion.span 
                  className="absolute -bottom-1 left-0 h-0.5 bg-blue-700 w-0"
                  variants={{
                    hover: { width: "100%" }
        ...
        {isMenuOpen && (
          ...
          >
            ...
            <div className="flex flex-col gap-3 mb-6">
              ...
              <Link to="/Ne-why-choose-us" className="text-blue-700 hover:text-blue-900 font-bold text-base">हामीलाई किन छान्ने</Link>
              <Link to="/Ne-contact" className="text-blue-700 hover:text-blue-900 font-bold text-base">हामीलाई सम्पर्क गर्नुहोस्</Link>
            ...
            <nav className="flex flex-col gap-3">
              ...
              >
                ...
                ></motion.span>
                <Link to="/Ne-shop">उत्पादन किनमेल गर्नुहोस्</Link>
              </motion.div>
              <motion.div 
                className="text-blue-700 hover:text-blue-900 font-bold text-lg flex items-center py-1.5 border-b border-blue-100 group"
                initial={{ x: -20, opacity: 0 }}
