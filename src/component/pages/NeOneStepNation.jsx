...
export default function NeOneStepNation() {
        ...
        <div className={`transition-all duration-1000 delay-300 ${isLoaded ? "opacity-100" : "opacity-0 -translate-y-12"}`}>
          <div className="text-center mb-16">
            <div className="inline-block mb-4">
              <div className="relative">
                ...
                <h1 className="text-5xl md:text-6xl font-bold tracking-tight text-gray-900">
                  <span className="text-gray-800">एउटा</span> <span className="text-[#5851DB]">कदम </span>
                </h1>
                <motion.div
            ...
            <p className="text-gray-600 max-w-xl mx-auto mt-8 text-lg">
              साफी एरियलमा, हामी हाम्रो राष्ट्रभरि समर्पित समुदाय पहलहरू मार्फत परिवर्तनका लहरहरू सिर्जना गर्दैछौं, जसले दीर्घकालीन प्रभाव पार्छ।
            </p>
          </div>
        </div>
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 z-20">
                <div className="flex justify-between items-end">
                  <div>
                    ...
                    <h3 className="text-2xl font-bold text-white mb-2">प्रभाव पार्दै</h3>
                    <p className="text-gray-100 text-sm max-w-lg">
                      हाम्रो समुदाय केन्द्रित परियोजनाहरूले देशभरि जीवनलाई रूपान्तरण गर्दैछन्।
                    </p>
                  </div>
                  <button 
