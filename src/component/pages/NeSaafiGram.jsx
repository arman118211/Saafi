      ...
      <div className="container mx-auto">
        ...
        >
          <h2 className="text-3xl md:text-5xl font-bold mb-4 text-gray-800">
              हाम्रो SaafiGram  <span className="text-[#5851DB]">जाँच गर्नुहोस्</span>
            </h2>
        ...
        >
          हाम्रो समुदायमा सामेल हुनुहोस् र हेर्नुहोस् कि Saafi Ariel कसरी लन्ड्री अनुभवहरूलाई रूपान्तरण गर्दैछ। #SaafiClean प्रयोग गरेर आफ्ना सफा क्षणहरू हाम्रो साथ साझा गर्नुहोस्।
        </motion.p>
