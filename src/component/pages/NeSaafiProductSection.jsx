      ...
      <div className="container mx-auto relative">
        ...
        <div className="text-center mb-16 relative">
          ...
          <h2 className="text-3xl md:text-5xl font-bold mb-4  text-gray-800">
              सर्वश्रेष्ठ चयन गर्नुहोस्  <span className="text-[#5851DB]">साफि उत्पादन तपाईंको लागि</span>
            </h2>
            <motion.div
          ...
          <div className="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-100 transition-all duration-300 hover:shadow-xl hover:scale-102">
            <div className="p-8 relative">
              ...
              <div className="flex items-center mb-4 relative z-10">
                ...
                <h3 className="text-2xl font-bold text-gray-800">प्रकार अनुसार ब्राउज़ गर्नुहोस्</h3>
              </div>
              
              <p className="text-gray-600 mb-6 text-lg leading-relaxed relative z-10">
                हाम्रो डिटर्जेन्टको श्रृंखला अन्वेषण गर्नुहोस् - पाउडर, लिक्विड, या क्याप्सुल। तपाईंको आवश्यकताअनुसार उपयुक्त रूप पत्ता लगाउनुहोस्।
              </p>
          ...
          <div className="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-100 transition-all duration-300 hover:shadow-xl hover:scale-102">
            <div className="p-8 relative">
              ...
              <div className="flex items-center mb-4 relative z-10">
                ...
                <h3 className="text-2xl font-bold text-gray-800">आवश्यकताअनुसार अन्वेषण गर्नुहोस्</h3>
              </div>
              
              <p className="text-gray-600 mb-6 text-lg leading-relaxed relative z-10">
                तपाईंको विशिष्ट लुगा धोनेको चुनौतीहरू - दाग हटाउने, कपडा हेरचाह, वा ताजगीका लागि अनुकूलित उत्पादनहरूको अन्वेषण गर्नुहोस्।
              </p>
...
export default NeSaafiProductSection